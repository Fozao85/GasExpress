...
export function BriefcaseIcon({ size = 22 }: { size?: number }) {
  return (
...
export function MapPinIcon({ size = 18, filled = false }: { size?: number; filled?: boolean }) {
  return (
...
export function StarIcon({ size = 20, filled = false }: { size?: number; filled?: boolean }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? '#FF8F00' : 'none'} stroke={filled ? '#FF8F00' : '#CBD5E1'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function GasCylinderIcon({ size = 32, color = 'white' }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 40 48" fill="none">
      <rect x="12" y="16" width="16" height="28" rx="4" fill={color} />
      <rect x="15" y="10" width="10" height="8" rx="2" fill={color} opacity="0.85" />
      <rect x="17" y="6" width="6" height="5" rx="2" fill={color} opacity="0.7" />
      <rect x="12" y="22" width="16" height="12" fill={color} opacity="0.15" />
      <path d="M20 25 C20 25 18 27.5 18 29 C18 30.5 19 31.5 20 31.5 C21 31.5 22 30.5 22 29 C22 27.5 20 25 20 25Z" fill={color} opacity="0.5" />
    </svg>
  )
}

export function TruckIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function AlertCircleIcon({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
