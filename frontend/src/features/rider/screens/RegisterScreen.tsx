...
export function RiderRegisterScreen() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      navigate('/rider/otp', { state: { phone: form.phone, type: 'VERIFICATION' } });
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-6 bg-gray-50">
      <div className="mb-8 text-center">
        ...
        <p className="text-gray-600 mt-1">Sign up to deliver gas</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-sm mx-auto w-full">
        ...
        <p className="text-center text-sm text-gray-600">
          Already registered?{' '}
          <Link to="/rider/login" className="text-primary-500 font-medium hover:underline">
            Login
          </Link>
        </p>
      </form>
